...
def main():
    # --- Configuration ---
    weights_path = "./artifacts/eighteenthOutput/binary_extractor.pt"
    json_path = "./clipLabels/clip_labels_16.json"
    output_path = "./binaryEmbeddings/eighteenthOutput/binary_results.json"
